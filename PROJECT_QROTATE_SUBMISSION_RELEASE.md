...
| **Technical Performance & Hardware Use** | **30%** | Correctness, benchmark gains, scalability, hardware utilization | **Quantinuum Native Compilation:** Each SWAP-test circuit rebases to 9 qubits, 62 `PhasedX`, 32 `ZZPhase`, 1 measurement (depth 68), ≈13.6 estimated HQCs per 100-shot run; dynamic mid-circuit measurement/reset loop in **Guppy**; 6 real-world benchmark active sites. |
...
* **Qubits Allocated:** 9 Qubits (4 pocket + 4 ligand + 1 ancilla; all-to-all trapped-ion connectivity, 0 SWAPs)
