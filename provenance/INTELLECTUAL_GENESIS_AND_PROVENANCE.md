...
In an era saturated with automated code generation, the foundational algorithmic breakthrough of Project Q-Rotate was conceived through **human domain intuition and synesthetic spatial-to-phase translation** by **Gwendalynn (婉婷) Lim ("1ightray")** (B.Sc. Hons in Applied Computing, SIT; Advanced AI/ML Credentials, NTU SCTP).

AI systems were leveraged solely as **engineering force multipliers**—accelerating compiler lowering, syntax verification, and test execution. The mathematical soul, the Lie algebra continuous rotation formulation, and the dynamic trapped-ion architecture originated entirely from human architectural design.
...
### Pillar I: Breaking the Spatial Paradigm (Synesthetic Phase Cascading)
...
Gwen's breakthrough was translating **spatial geometry into an information-theoretic phase cascade**. By abstracting physical coordinate rotation into continuous unitary evolution, the heaviest, most intractable part of molecular docking was eliminated analytically before touching the quantum circuit.
